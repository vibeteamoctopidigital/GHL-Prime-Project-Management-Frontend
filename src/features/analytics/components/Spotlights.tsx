...
import { PERIOD_LABELS, type MemberStats, type LeadStats, type Period } from '../constants';

interface Props {
  topEmployee?: MemberStats;
  topLead?: LeadStats;
  period: Period;
}

export default function Spotlights({ topEmployee, topLead, period }: Props) {
  return (
